...
def main() -> None:
    ...
    tokenizer = AutoTokenizer.from_pretrained(args.model_name, revision="8ccc9b6f36199bec6961081d44eb72fb3f7353f3")
    model = DeBERTaCRFTagger(args.model_name, 2).to(device)

    ckpt = torch.load(args.best_model_path, map_location=device, weights_only=True)
